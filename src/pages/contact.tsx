                    ...
                    <div className="space-y-6">
                      <div className="flex items-start">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="text-gray-600 mt-1">123 Happy Street, New York, NY 10001</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="text-gray-600 mt-1">(251) 261-5451</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-start">
                        ...
                        <div className="ml-4">
                          ...
                          <p className="text-gray-600 mt-1">support@shophappy.com</p>
                        </div>
                      </div>
