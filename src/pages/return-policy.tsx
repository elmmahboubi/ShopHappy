          ...
          <div className="bg-white rounded-xl shadow-sm p-6 lg:p-8">
            ...
            <div className="prose max-w-none text-gray-600">
              <p className="text-lg mb-6">
                At ShopHappy, we want you to be completely satisfied with your purchase. If you're not entirely happy with your order, we're here to help.
              </p>
              ...
              <ol className="list-decimal pl-6 space-y-2">
                <li>Contact our customer service team at (251) 261-5451 to initiate a return</li>
              ...
              <ul className="list-none mt-4">
                ...
                <li>Email: support@shophappy.com</li>
