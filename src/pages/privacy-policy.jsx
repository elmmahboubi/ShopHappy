          ...
          <div className="bg-white rounded-xl shadow-sm p-6 lg:p-8">
            ...
            <div className="prose max-w-none text-gray-600">
              <p className="text-lg mb-6">
                At ShopHappy, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website.
              </p>
              ...
              <ul className="list-none mt-4">
                ...
                <li>Email: privacy@shophappy.com</li>
                <li>Address: 123 Happy Street, New York, NY 10001</li>
              </ul>
            </div>
          </div>
        </div>
