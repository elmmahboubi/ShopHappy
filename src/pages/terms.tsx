          ...
          <div className="bg-white rounded-xl shadow-sm p-6 lg:p-8">
            ...
            <div className="prose max-w-none text-gray-600">
              <p className="text-lg mb-6">
                Welcome to ShopHappy. By accessing or using our website, you agree to be bound by these Terms of Service.
              </p>
              ...
              <p>
                ShopHappy shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of our services.
              </p>
              ...
              <ul className="list-none mt-4">
                <li>Phone: (251) 261-5451</li>
                <li>Email: legal@shophappy.com</li>
